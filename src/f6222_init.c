 ...
 * SPI trace — Logic Analyzer capture exported as F6222_init.csv (64 writes).
 * Not an independent translation of datasheet prose.
 *
 * f6222_init() sequence: wait_ready → scratch_test → set_init_pattern (64 writes)
 ...
 * 64 local register writes, RF Load = immediate. Not derived from datasheet prose. */
static const f6222_init_entry_t f6222_init_pattern[] = {
    ...
    {0x65u, 0x0000u}, {0x01u, 0x0682u}, /* PTAT_BIAS_CFG */
    {0x09u, 0x0000u}, {0x07u, 0x0000u}, {0x25u, 0xA91Au}, {0x26u, 0x0E7Fu}, {0x28u, 0x0000u}, {0x27u, 0x03FFu},
    {0x2Au, 0x0000u}, {0x2Cu, 0x0000u}, {0x29u, 0x0048u}, {0x2Du, 0xA91Au}, {0x2Eu, 0x0E7Fu}, {0x30u, 0x0000u},
    {0x2Fu, 0x03FFu}, {0x32u, 0x0000u}, {0x34u, 0x0000u}, {0x31u, 0x0048u}, {0x35u, 0xA91Au}, {0x36u, 0x0E7Fu},
    {0x38u, 0x0000u}, {0x37u, 0x03FFu}, {0x3Au, 0x0000u}, {0x3Cu, 0x0000u}, {0x39u, 0x0048u}, {0x3Du, 0xA91Au},
    {0x3Eu, 0x0E7Fu}, {0x40u, 0x0000u}, {0x3Fu, 0x03FFu}, {0x42u, 0x0000u}, {0x44u, 0x0000u}, {0x41u, 0x0048u},
    {0x45u, 0xA91Au}, {0x46u, 0x0E7Fu}, {0x48u, 0x0000u}, {0x47u, 0x03FFu}, {0x4Au, 0x0000u}, {0x4Cu, 0x0000u},
    {0x49u, 0x0048u}, {0x4Du, 0xA91Au}, {0x4Eu, 0x0E7Fu}, {0x50u, 0x0000u}, {0x4Fu, 0x03FFu}, {0x52u, 0x0000u},
    {0x54u, 0x0000u}, {0x51u, 0x0048u}, {0x55u, 0xA91Au}, {0x56u, 0x0E7Fu}, {0x58u, 0x0000u}, {0x57u, 0x03FFu},
    {0x5Au, 0x0000u}, {0x5Cu, 0x0000u}, {0x59u, 0x0048u}, {0x5Du, 0xA91Au}, {0x5Eu, 0x0E7Fu}, {0x60u, 0x0000u},
    {0x5Fu, 0x03FFu}, {0x62u, 0x0000u}, {0x64u, 0x0000u}, {0x61u, 0x0048u},
};
